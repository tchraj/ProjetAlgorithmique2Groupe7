...
def main():
    ...
    resultats = validator.valider_fichier_instances("instances/reference_instances.json")
    ...
    resultats_test = validator.valider_fichier_instances("instances/test_instances.json")
